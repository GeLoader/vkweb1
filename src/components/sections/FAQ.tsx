...
const faqData: FAQ[] = [
  ...
  },
  {
    ...
    answer: "The certification timeline varies depending on the complexity of your products and production processes. Simple products may be certified within 2-4 weeks, while more complex operations can take 2-3 months. Our team works efficiently to minimize disruption to your business."
